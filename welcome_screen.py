...
def welcome_screen():
    ...
    easy_width = 110
    easy_height = 40
    easy_x = 45 # change the easy_x from 145
    easy_y = HEIGHT // 2 + 30
    ...
    easy_rect = easy_surf.get_rect(center=(100, HEIGHT // 2 + 50)) # change the easy_x from 200
    screen.blit(easy_surf, easy_rect)

    # medium text outline
    medium_width = 110
    medium_height = 40
    medium_x = 245 # change the medium_x from 345
    ...
    medium_rect = medium_surf.get_rect(center=(300, HEIGHT // 2 + 50)) # change the medium_x from 400
    screen.blit(medium_surf, medium_rect)

    # hard text outline
    hard_width = 110
    hard_height = 40
    hard_x = 445 # change the hard_x from 545
    hard_y = HEIGHT // 2 + 30
    ...
    hard_rect = hard_surf.get_rect(center=(500, HEIGHT // 2 + 50)) # change the hard_x from 600
